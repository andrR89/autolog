...
mixin _$Reminder {
 ...
 String get id; String get vehicleId;@ReminderTypeConverter() ReminderType get type; String get title; int? get dueKm; DateTime? get dueDate; bool get isDone; DateTime get createdAt; DateTime get updatedAt; DateTime? get deletedAt;@SyncStatusConverter() SyncStatus get syncStatus;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,vehicleId,type,title,dueKm,dueDate,isDone,createdAt,updatedAt,deletedAt,syncStatus);

@override
String toString() {
  return 'Reminder(id: $id, vehicleId: $vehicleId, type: $type, title: $title, dueKm: $dueKm, dueDate: $dueDate, isDone: $isDone, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, syncStatus: $syncStatus)';
}
...
@useResult
$Res call({
 String id, String vehicleId,@ReminderTypeConverter() ReminderType type, String title, int? dueKm, DateTime? dueDate, bool isDone, DateTime createdAt, DateTime updatedAt, DateTime? deletedAt,@SyncStatusConverter() SyncStatus syncStatus
});
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? vehicleId = null,Object? type = null,Object? title = null,Object? dueKm = freezed,Object? dueDate = freezed,Object? isDone = null,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,Object? syncStatus = null,}) {
...
switch (_that) {
case _Reminder() when $default != null:
return $default(_that.id,_that.vehicleId,_that.type,_that.title,_that.dueKm,_that.dueDate,_that.isDone,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.syncStatus);case _:
  return orElse();
...
class _Reminder implements Reminder {
  const _Reminder({required this.id, required this.vehicleId, @ReminderTypeConverter() required this.type, required this.title, this.dueKm, this.dueDate, required this.isDone, required this.createdAt, required this.updatedAt, this.deletedAt, @SyncStatusConverter() required this.syncStatus});
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? vehicleId = null,Object? type = null,Object? title = null,Object? dueKm = freezed,Object? dueDate = freezed,Object? isDone = null,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,Object? syncStatus = null,}) {
